...
const SideDrawer = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            toast({
                title: "Error Occured!",
                description: "Failed ot load the Search Results",
                status: "error",
                duration: 5000,
                isClosable: true,
                position: "bottom-left"
    ...
    return (
        <>
            ...
            <Box
                display={'flex'} justifyContent={"space-between"} alignItems={"center"} bg={"white"} w={"100%"} p={"5px 10px 5px 10px"}
                borderWidth={"5px"}
            >
                    ...
                    <DrawerBody>
                        ...
                        {loading ? (
                            ...
                            searchResult?.map(user => (
                                <UserListItem key={user._id} user={user} handleAccessUser={() => accessChat(user._id)} />
                            ))
                        )}
